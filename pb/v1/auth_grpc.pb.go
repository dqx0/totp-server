...
const (
	AuthService_GenerateTOTP_FullMethodName = "/dqx0.totp_auth.v1.AuthService/GenerateTOTP"
	AuthService_ValidateTOTP_FullMethodName = "/dqx0.totp_auth.v1.AuthService/ValidateTOTP"
)
...
func (c *authServiceClient) GenerateTOTP(ctx context.Context, in *GenerateTOTPRequest, opts ...grpc.CallOption) (*GenerateTOTPResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GenerateTOTPResponse)
	err := c.cc.Invoke(ctx, AuthService_GenerateTOTP_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedAuthServiceServer) GenerateTOTP(context.Context, *GenerateTOTPRequest) (*GenerateTOTPResponse, error) {
...
func _AuthService_GenerateTOTP_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GenerateTOTPRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthServiceServer).GenerateTOTP(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AuthService_GenerateTOTP_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).GenerateTOTP(ctx, req.(*GenerateTOTPRequest))
	}
...
var AuthService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "dqx0.totp_auth.v1.AuthService",
	HandlerType: (*AuthServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "GenerateTOTP",
			Handler:    _AuthService_GenerateTOTP_Handler,
		},
		{
